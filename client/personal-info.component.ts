...
import { EUserType, ICountry, ILanguage, IPersonalInfoForm, IPersonalInfoState, IState, PhoneNumber, IPersonalInfo } from 'app/iaw/models';
import { Observable, Subject, forkJoin, of } from 'rxjs';
import { takeUntil } from 'rxjs/operators';
import { CommonUtilsService } from 'app/iaw/services/common-utils.service';
import { ApplicationHttpService } from 'app/iaw/services/application-http.service';
import { ApplicationService } from 'app/shared/services/application.service';
import { FormValidationService } from 'app/iaw/services/form-validation.service';
import { Helper } from 'app/iaw/shared/common/helper';
...
export class PersonalInfoComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  public countryList: ICountry[] = null;
  ...
  public onSaveClick(event: Event) {
    ...
    if (this.personalInfoForm.valid) {
      ...
      this.httpService.postPersonalInfo(this.personalInfoForm.value).subscribe();
      ...
      this.applicationService.setLandingRoute();
    }
    else {
  ...
  private loadFormData() {
    ...
    forkJoin(
      this.httpService.getPersonalInfo(),
      this.httpService.getLanguageList(),
      this.httpService.getCountryList()
    )
      .subscribe
      (
        ([
          ...
          if (cachedInfo) {
            personalInfoData = Object.assign(cachedInfo);
          }
